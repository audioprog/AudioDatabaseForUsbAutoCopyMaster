...
uint Frame::headerSize()
{
  return Header::size();
}

uint Frame::headerSize(uint version)
{
...
static const uint txxxFrameTranslationSize = 8;
...
uint Frame::Header::size()
{
  return size(4);
}

uint Frame::Header::size(uint version)
{
  switch(version) {
  case 0:
  case 1:
...
uint Frame::Header::frameSize() const
{
  return d->frameSize;
}
...
uint Frame::Header::version() const
{
  return d->version;
}

void Frame::Header::setVersion(uint version)
{
  d->version = version;
}
