...
uint Header::majorVersion() const
{
  return d->majorVersion;
}

void Header::setMajorVersion(uint version)
{
  d->majorVersion = version;
}

uint Header::revisionNumber() const
{
...
uint Header::tagSize() const
{
  return d->tagSize;
}

uint Header::completeTagSize() const
{
  if(d->footerPresent)
