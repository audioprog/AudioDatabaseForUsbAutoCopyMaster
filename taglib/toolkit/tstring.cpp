...
String::String(const QString& qString) : d(new StringPrivate())
{
	QByteArray out = qString.toUtf8();
	copyFromUTF8(out.constData(), out.count());
}
...
{
	return QString::fromWCharArray(d->data.data(), d->data.size());
}
